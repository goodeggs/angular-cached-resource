...
app.factory('$cachedResource', [
  '$resource', '$timeout', '$q', function($resource, $timeout, $q) {
    var CACHE_RETRY_TIMEOUT, CachedResourceManager, LOCAL_STORAGE_PREFIX, ResourceCacheArrayEntry, ResourceCacheEntry, ResourceWriteQueue, cache, defaultActions, readArrayCache, readCache, writeCache;
    ...
    ResourceWriteQueue = (function() {
      ...
      ResourceWriteQueue.prototype.flush = function() {
        var cacheEntry, entry, onFailure, onSuccess, _i, _len, _ref, _results;
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          onSuccess = (function(_this) {
            return function(value) {
              ...
              return (_ref1 = entry.deferred) != null ? _ref1.resolve(value) : void 0;
            };
          })(this);
          onFailure = (function(_this) {
            return function(error) {
              var _ref1;
              return (_ref1 = entry.deferred) != null ? _ref1.reject(error) : void 0;
            };
          })(this);
          _results.push(this.CachedResource.$resource[entry.action](entry.params, cacheEntry.value, onSuccess, onFailure));
        }
        return _results;
      };
    ...
    readCache = function(name, CachedResource) {
      return function() {
        var args, cacheDeferred, cacheEntry, error, httpDeferred, instance, params, resource, success;
