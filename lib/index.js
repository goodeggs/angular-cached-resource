...
var DEFAULT_ACTIONS, app, resourceManagerListener,
  __slice = [].slice;
...
app.factory('$cachedResource', [
  '$resource', '$timeout', '$q', '$log', function($resource, $timeout, $q, $log) {
    var $cachedResource, CachedResourceManager, ResourceCacheArrayEntry, ResourceCacheEntry, cache, modifyObjectInPlace, processReadArgs, readArrayCache, readCache, resourceManager, writeCache;
